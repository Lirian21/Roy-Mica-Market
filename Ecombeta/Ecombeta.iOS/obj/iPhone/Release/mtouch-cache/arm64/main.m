...
extern void *mono_aot_module_Ecombeta_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_Ecombeta_info;
...
extern void *mono_aot_module_WooCommerce_NET_info;
...
extern void *mono_aot_module_WordPressPCL_info;
...
{
	mono_aot_register_module (mono_aot_module_Ecombeta_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_Ecombeta_info);
	...
	mono_aot_register_module (mono_aot_module_WooCommerce_NET_info);
	...
	mono_aot_register_module (mono_aot_module_WordPressPCL_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "Ecombeta.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
